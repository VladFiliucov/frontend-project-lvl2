...
Property 'new_object' was added with value: [complex value]`;
  ...
  formattedJSONDiff = `[{"key":"name","nestingLevel":1,"type":"persisted","data":"gendiff"},{"key":"type","nestingLevel":1,"type":"modified","removedData":"module","addedData":true},{"key":"version","nestingLevel":1,"type":"persisted","data":"1.0.0"},{"key":"setting6","nestingLevel":1,"type":"parent","children":[{"key":"key","nestingLevel":2,"type":"persisted","data":"value"},{"key":"ops","nestingLevel":2,"type":"addition","data":"vops"}]},{"key":"description","nestingLevel":1,"type":"modified","removedData":"CLI tool for comparing config files","addedData":"CLI foo tool for comparing config files"},{"key":"proxy","nestingLevel":1,"type":"removal","data":false},{"key":"nest","nestingLevel":1,"type":"removal","data":{"type":"module","moreNest":{"name":"vlad"}}},{"key":"simple","nestingLevel":1,"type":"modified","removedData":true,"addedData":{"made_easy":true,"and":{"even":"easier"}}},{"key":"subset","nestingLevel":1,"type":"parent","children":[{"key":"key","nestingLevel":2,"type":"parent","children":[{"key":"foo","nestingLevel":3,"type":"modified","removedData":"bar","addedData":"baz"}]}]},{"key":"verbose","nestingLevel":1,"type":"addition","data":true},{"key":"new_object","nestingLevel":1,"type":"addition","data":{"name":"zara home","address":{"street":"four dials","postcode":"E20"}}}]`;
});
